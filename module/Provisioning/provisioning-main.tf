module "pv-ps-grp-cdso-admin" {
  source = "./provisioning"
    ...
    permission_set_arn = module.ps-grp-cdso-admin-managed.ps-grp-cdso-admin-arn
...
module "pv-ps-grp-pss-pns-admin" {
  source = "./provisioning/"
    ...
    permission_set_arn = module.ps-grp-pss-pns-admin-managed.ps-grp-pss-pns-admin-arn
